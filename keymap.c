...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
static void oled_render_layer_state(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        case 0:
            oled_write_ln(PSTR("QWERTY"), false);
            break;
        case 1:
            oled_write_ln(PSTR("NUMBERS"), false);
            break;
        case 2:
            oled_write_ln(PSTR("SIMBOLS"), false);
            break;
        case 3:
            oled_write_ln(PSTR("LIGHTS"), false);
            break;
    }
}
